                                ...
                                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                    <nav class="linkEffects linkHoverEffect_12">
                                        <ul>
                                            ...
                                            <li><a href="#about" class="scroll"><span>DATOS PERSONALES</span></a></li> 
                                        <li><a href="#services" class="scroll"><span>GESTIONAR CLIENTES</span></a></li> 
                                        <li><a href="#services" class="scroll"><span>GESTIONAR CUENTAS</span></a></li> 
                                        <li><a href="#services" class="scroll"><span>REGISTRAR SOLICITUD</span></a></li> 
